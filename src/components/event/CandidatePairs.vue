...
<div v-if="candidateTeam" class="min-w-full mx-auto">
    <table v-if="candidateTeam.candidates.length >0" class="min-w-full border-collapse border-spacing-0 border border-slate-400">
        <thead>
            <tr>
                ...
                <th v-for="candidate in candidateTeam.candidates" class="px-3 py-2 bg-slate-700 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">
                    {{candidate.name}}
                </th>
            </tr>
            <tr>
            ...
            <tr v-for="candidate1 in candidateTeam.candidates" class="even:bg-slate-50 odd:bg-slate-400">
                ...
                <td v-for="candidate2 in candidateTeam.candidates" class="px-3 py-2 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">
    ...
    <table class="my-5 border-collapse border-spacing-0 border border-slate-400">
        <tr v-for="(line, key) in candidateTeam.lines" class="px-3 py-2 whitespace-no-wrap border-2 text-blue-900 border-gray-500 text-sm leading-5" >
            <td>{{key}}</td>
