...
<template>
     <div class="p-5 flex flex-col w-full justify-center rounded-lg z-10 shadow-lg border border-gray-500">
        ...
        <div class="flex items-center h-12 px-4 border-b border-gray-500 font-medium font-semibold">
        ...
        <div v-if="team1.bestUTRSingle" class="flex items-center h-12 px-4 border-b border-gray-500 font-medium font-semibold">
        ...
        <div v-if="team1.doubleLineStats">
            <div v-for="(doubleLineStat, index) in team1.doubleLineStats" class="flex items-center h-12 px-4 border-b border-gray-500 font-medium font-semibold">
        ...
        <div v-if="team1.singleLineStats">
            <div v-for="(singleLineStat, index) in team1.singleLineStats" class="flex items-center h-12 px-4 border-b border-gray-500 font-medium font-semibold">
