...
<template>
    ...
    <Modal v-model="showModal" :title="score.name">
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 w-400 h-200">
            <div class="mb-4">
              ...
              <LinePlayerInfo :player1="score.homePlayer1" :player2="score.homePlayer2" :winner="score.homeTeamWin" :matchType="score.type"
            ...
            <div class="mb-6">
              ...
              <LinePlayerInfo :player1="score.guestPlayer1" :player2="score.guestPlayer2" :winner="!score.homeTeamWin" :matchType="score.type"
              class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-sm" />
            </div>
            <div class="mb-6">
